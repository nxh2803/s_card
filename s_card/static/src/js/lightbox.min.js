...
!function(i) {
    ...
    function t(t) {
        ...
        e.on("swipeRight swipeLeft", function(i) {
            ...
            t.preventDefault(),
            e.lightbox[i.$(this).is("[data-lightbox-next]") ? "next" : "previous"]()
        }),
        ...
        return i.$win.on("load resize orientationchange", i.Utils.debounce(function() {
            o.w !== window.innerWidth && e.is(":visible") && !i.Utils.isFullscreen() && e.lightbox.fitSize(),
            o = {
                w: window.innerWidth,
                h: window.innerHeight
            }
    ...
    return i.component("lightbox", {
        ...
        boot: function() {
            i.$html.on("click", "[data-uk-lightbox]", function(t) {
                t.preventDefault();
                var e = i.$(this);
                e.data("lightbox") || i.lightbox(e, i.Utils.options(e.attr("data-uk-lightbox"))),
        ...
        show: function(e) {
            ...
            e = e || 0,
            "object" == typeof e && this.siblings.forEach(function(i, t) {
                e[0] === i.link[0] && (e = t)
            }),
        ...
        fitSize: function() {
            ...
            e.title && (this.modal.dialog.append('<div class="uk-modal-caption">' + e.title + "</div>"),
            r -= this.modal.dialog.find(".uk-modal-caption").outerHeight()),
            d < e.meta.width && (g = Math.floor(g * (d / c)),
            c = d),
            g > r && (g = Math.floor(r),
                ...
                h) {
                    if (o[h])
                        ...
                        d.onload = function() {
                            ...
                            l(h, o[h].width, o[h].height)) : (r = !0,
                            d.src = "//img.youtube.com/vi/" + h + "/0.jpg") : (o[h] = {
                                width: d.width,
                                height: d.height
                            },
    ...
    i.plugin("lightbox", "vimeo", {
        init: function(t) {
            ...
            t.on("showitem.uk.lightbox", function(t, h) {
                ...
                (n = h.source.match(s)) && (a = n[2],
                o[a] ? l(a, o[a].width, o[a].height) : i.$.ajax({
                    type: "GET",
                    ...
                    if (o[e.source])
                        ...
                        var s = i.$('<video style="position:fixed;visibility:hidden;top:-10000px;"></video>').attr("src", e.source).appendTo("body")
                          , h = setInterval(function() {
                            s[0].videoWidth && (clearInterval(h),
                            o[e.source] = {
