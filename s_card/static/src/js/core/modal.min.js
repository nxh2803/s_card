...
!function(t) {
    ...
    t.component("modal", {
        ...
        init: function() {
            ...
            this.element.length) {
                ...
                this.on("click", ".uk-modal-close", function(e) {
                    e.preventDefault();
                    var o = t.$(e.target).closest(".uk-modal");
                    o[0] === i.element[0] && i.hide()
                }).on("click", function(e) {
                    var o = t.$(e.target);
        ...
        show: function() {
            if (this.element.length) {
                var i = this;
                if (!this.isActive())
                    return this.options.modal && o && o.hide(!0),
                    this.element.removeClass("uk-open").show(),
                    this.resize(!0),
                    this.options.modal && (o = this),
                    this.active = !0,
                    n++,
    ...
    t.component("modalTrigger", {
        boot: function() {
            ...
            t.$html.on("keydown.modal.uikit", function(t) {
                o && 27 === t.keyCode && o.options.keyboard && (t.preventDefault(),
                o.hide())
            })
        },
        init: function() {
    ...
    t.modal.dialog = function(e, o) {
        ...
        return n.on("hide.uk.modal", function() {
            n.persist && (n.persist.appendTo(n.persist.data("modalPersistParent")),
            n.persist = !1),
            n.element.remove()
        }),
        i(e, n),
    ...
    t.modal.confirm = function(i, e, o) {
        ...
        return s.element.find(".js-modal-confirm, .js-modal-confirm-cancel").on("click", function() {
            t.$(this).is(".js-modal-confirm") ? e() : o(),
            s.hide()
        }),
